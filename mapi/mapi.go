...
func mapiRequestRPC(body []byte) ([]byte, error) {
	...
	if AuthSession.RPCSet == false {
		...
		rpchttp.RPCRead()
		resp, err = rpchttp.RPCConnectRequest(body)
